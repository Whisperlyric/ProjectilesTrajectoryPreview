...
public class RenderUtils {
    ...
    public static void renderVector(LevelRenderContext context, PoseStack poseStack, RenderType renderType, Vector3f vector3f, Vec3 vec3, int i) {
        context.submitNodeCollector().submitCustomGeometry(poseStack, renderType, (Pose pose, VertexConsumer vertexConsumer) -> {
    ...
    private static void addChainedFilledBoxVertices(LevelRenderContext context, PoseStack poseStack, RenderType renderType, double d, double e, double f, double g, double h, double i, float j, float k, float l, float m) {
        addChainedFilledBoxVertices(context, poseStack, renderType, (float)d, (float)e, (float)f, (float)g, (float)h, (float)i, j, k, l, m);
    }

    private static void addChainedFilledBoxVertices(LevelRenderContext context, PoseStack poseStack, RenderType renderType, float f, float g, float h, float i, float j, float k, float l, float m, float n, float o) {
        context.submitNodeCollector().submitCustomGeometry(poseStack, renderType, (Pose pose, VertexConsumer vertexConsumer) -> {
    ...
    private static void renderLineBox(LevelRenderContext context, PoseStack poseStack, RenderType renderType, double d, double e, double f, double g, double h, double i, float j, float k, float l, float m) {
        renderLineBox(context, poseStack, renderType, d, e, f, g, h, i, j, k, l, m, j, k, l);
    }

    private static void renderLineBox(LevelRenderContext context, PoseStack poseStack, RenderType renderType, double d, double e, double f, double g, double h, double i, float j, float k, float l, float m, float n, float o, float p) {
        float q = (float)d;
        float r = (float)e;
        float s = (float)f;
        float t = (float)g;
